      ...
      <ImageBackground
        ...
        >
          <View
            ...
            <Text style={MainStyles.whiteText}>{t('type')}</Text>
            <TouchableOpacity
              ...
              <View style={MainStyles.textContainer}>
                <Text style={[MainStyles.mainTitle, MainStyles.paddinText]}>{t('client')}</Text>
                <Text style={[MainStyles.mainText, MainStyles.paddinText]}>{t('clientDescription')}</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              style={MainStyles.setupContainer}
              ...
              <View>
  <Text style={[MainStyles.mainTitle, MainStyles.paddinText]}>{t('caretaker')}</Text>
                <Text style={[MainStyles.mainText, MainStyles.paddinText]}>{t('caretakerDescription')}</Text>
              </View>
            </TouchableOpacity>
